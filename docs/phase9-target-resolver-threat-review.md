...
- Full deterministic suite after the resolver: 513 passed, 17 skipped on Windows on 2026-09-13.
  The suite collected 530 tests.
- New resolver coverage: 17 focused capability tests and 10 integration tests covering schema
  ...
  ordinary no-call conversation, content-search separation, and no-match behavior.
