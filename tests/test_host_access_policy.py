...
def test_phase9_policy_exposes_separately_gated_content_and_search():
    ...
    assert "filesystem_search_enabled" in production
    assert "filesystem.search" in production
